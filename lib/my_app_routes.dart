...
// import '../state_scoped_model_ex.dart';
  ...
  MyRouteGroup(
    ...
    routes: <MyRoute>[
      ...
      MyRoute(
        ...
        links: {
          'Blog': 'https://www.digitalocean.com/community/tutorials/flutter-flutter-gradient',
        },
      ),
      MyRoute(
        ...
        title: 'Buttons',
        description: 'ElevatedButton, TextButton, OutlineButton, IconButton&Tooltips',
        links: {
  ...
  MyRouteGroup(
    ...
    routes: <MyRoute>[
      ...
      MyRoute(
        ...
        description: 'Sizing widgets to a fraction of the total available space.',
  ...
  MyRouteGroup(
    ...
    routes: <MyRoute>[
      ...
      MyRoute(
        ...
        links: {
          'Doc': 'https://docs.flutter.io/flutter/material/ReorderableListView-class.html',
  ...
  MyRouteGroup(
    ...
    routes: <MyRoute>[
      ...
      MyRoute(
        ...
        description: 'A flutter package with some cool and awesome text animations.',
        links: {'Pub package': 'https://pub.flutter-io.cn/packages/animated_text_kit'},
      ),
    ],
  ),
  MyRouteGroup(
    ...
    routes: <MyRoute>[
      ...
      MyRoute(
        ...
        links: {
          ...
          'Full list of examples': 'https://github.com/brendan-duncan/image/wiki/Examples',
        },
      ),
      MyRoute(
  ...
  MyRouteGroup(
    ...
    routes: <MyRoute>[
      ...
      MyRoute(
        ...
        title: 'Hive',
        description: 'Easier NoSQL db with less bolierplate code. Mini todo CRUD app.',
        links: {
          'Documentation': 'https://docs.hivedb.dev',
          'ResoCoder blog': 'https://resocoder.com/2019/09/30/hive-flutter-tutorial-lightweight-fast-database'
        },
      ),
    ],
  ),
    ...
    routes: <MyRoute>[
      ...
      MyRoute(
        ...
        links: {
          ...
          'Flutter documentation ': 'https://flutter.dev/docs/development/data-and-backend/state-mgmt/simple',
  ...
  MyRouteGroup(
    ...
    routes: <MyRoute>[
      MyRoute(
        ...
        links: {'Demo gallery': 'https://google.github.io/charts/flutter/gallery.html'},
      ),
      MyRoute(
      ...
      MyRoute(
        ...
        links: {'doc': 'https://github.com/imaNNeoFighT/fl_chart/blob/master/repo_files/documentations/line_chart.md'},
      ),
      MyRoute(
        child: FlBarChartExample(),
        sourceFilePath: 'lib/routes/charts_fl_bar_chart_ex.dart',
        title: 'BarChart with fl_chart',
        links: {'doc': 'https://github.com/imaNNeoFighT/fl_chart/blob/master/repo_files/documentations/bar_chart.md'},
      ),
      MyRoute(
        child: FlPieChartExample(),
        sourceFilePath: 'lib/routes/charts_fl_pie_chart_ex.dart',
        title: 'PieChart with fl_chart',
        links: {'doc': 'https://github.com/imaNNeoFighT/fl_chart/blob/master/repo_files/documentations/pie_chart.md'},
      ),
      MyRoute(
  ...
  MyRouteGroup(
    ...
    routes: <MyRoute>[
      MyRoute(
        ...
        title: 'Fetching data',
        links: {'Cookbook': 'https://flutter.dev/docs/cookbook/networking/fetch-data'},
      ),
      MyRoute(
...
const kMyAppRoutesInAction = <MyRouteGroup>[
  ...
  MyRouteGroup(groupName: 'App features', icon: Icon(Icons.featured_play_list), routes: <MyRoute>[
    MyRoute(
    ...
    MyRoute(
      ...
      links: {
        ...
        "Andrea's tutorial": 'https://codewithandrea.com/articles/flutter-api-keys-dart-define-env-files',
      },
    ),
    // TODO: i18n?
    // TODO: routing?
    ...
    routes: <MyRoute>[
      MyRoute(
        ...
        links: {
          ...
          'Documentation': 'https://developers.google.com/admob/flutter/banner/get-started',
        },
      ),
      MyRoute(
        ...
        links: {
          'Documentation': 'https://developers.google.com/admob/flutter/banner/anchored-adaptive',
        },
      ),
      MyRoute(
      ...
      MyRoute(
        ...
        links: {
          ...
          'Documentation': 'https://developers.google.com/admob/flutter/interstitial',
        },
      ),
      MyRoute(
        ...
        links: {
          'Documentation': 'https://developers.google.com/admob/flutter/rewarded',
          'pub.dev example': 'https://pub.dev/packages/google_mobile_ads/example',
        },
      ),
      MyRoute(
      ...
      MyRoute(
        ...
        description: 'Show user-purchaesd digital products (with firebase and riverpod).',
      ),
    ],
  ),
];
...
final kRouteNameToRoute = <String, MyRoute>{for (final route in kAllRoutes) route.routeName: route};
